...
//codigo utilizado do site https://developer.mozilla.org/pt-BR/docs/Web/API/Node/insertBefore
...
function moveUp() {
  ...
  if (list[0] !== elementSelected && elementSelected) {
    ...
    listaTarefas.insertBefore(elementUp, elementSelected.nextSibling);
  }
}
...
function moveDown() {
  ...
  if (list[list.length - 1] !== elementSelected && elementSelected) {
    ...
    listaTarefas.insertBefore(elementDown, elementSelected);
  }
}
